...
def process_and_update_docs(db_name):
    ...
    cur = conn.cursor()
    try:
        cur.execute("ALTER TABLE docs ADD COLUMN clean_text_bm25 TEXT;")
    except sqlite3.OperationalError:
        pass
    try:
        cur.execute("ALTER TABLE docs ADD COLUMN clean_text_stem TEXT;")
    except sqlite3.OperationalError:
        pass
    try:
        cur.execute("ALTER TABLE docs ADD COLUMN clean_text_bert TEXT;")
    except sqlite3.OperationalError:
        pass
